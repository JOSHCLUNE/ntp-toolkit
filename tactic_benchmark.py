...
parser.add_argument("--ntp_toolkit_path", type=str, default="/home/ubuntu/ntp-toolkit", help="Path to the ntp-toolkit repository containing a tactic_benchmark script.")
...
def run_benchmark(entry: dict, print_emoji: bool = False) -> dict[str, str]:
    ...
    result_data["result_outcome"] = result_outcome
    print(decl_name)
    print(module)
